...
module.exports.run = async function ({ args, Users, Threads, api, event, Currencies }) {
  ...
  let pathImg = __dirname + "/cache/nd29.png";
  ...
  var background = [
  "https://i.postimg.cc/bvDjPQhm/20240107-181421.png"
  ];
  ...
  ctx.drawImage(baseAvt1, 188, 164, 346, 363);
  ctx.drawImage(baseAvt2, 757, 164, 348, 365);
